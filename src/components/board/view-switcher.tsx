...
export function ViewSwitcher({ boardId }: { boardId: ID }) {
  ...
  return (
    <div className="inline-flex items-center gap-1 bg-black/30 backdrop-blur-sm rounded-lg px-1 py-1 max-w-full overflow-x-auto [&::-webkit-scrollbar]:hidden [scrollbar-width:none]">
