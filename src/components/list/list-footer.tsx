  ...
  return (
    <div className="px-2 pb-2 pt-1 flex flex-col gap-2">
      <textarea
        ref={textareaRef}
        rows={1}
        className="w-full bg-trello-cardBg text-trello-text rounded-lg px-3 py-2 text-sm outline-none resize-none ring-1 ring-trello-accent focus:ring-2 focus:ring-trello-accent leading-5 placeholder:text-trello-textSubtle"
